        ...
        <div class="relative w-full max-w-2xl px-4 h-full md:h-auto">
            ...
            <div class="rounded-lg shadow relative" style="background-color: #374050;">
                ...
                <div class="flex items-start justify-between p-5 border-b rounded-t" style="border-color: rgba(255,255,255,0.2);">
                    ...
                    <div>
                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-500 text-sm p-1.5 inline-flex" onclick="openEditWindow()">
                        ...
                        <button onclick="deleteProduct()" type="button" class="text-gray-400 bg-transparent hover:bg-gray-500 text-sm p-1.5 inline-flex">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="20" height="20" fill="black" fill-opacity="0.4"/>
                ...
                <div class="p-6 space-y-6">
                    <div>
                        <div class="text-container">
                            ...
                            <div id="articleShowId" class="text-style-2">
...
<script>
    ...
    function showData(product)
    {
        ...
        for (let key in obj) {
            if (obj.hasOwnProperty(key)) {
                let value = obj[key];
                attributes += `<div class="text-style-3">${key}: ${value}</div> <br>`;
            }
        }
    ...
    {
        let confirm_m = confirm(`Вы уверены удалить продукт  ${current_product.name}`);
        if(confirm_m)
        {
            location.href = `/product/delete/${current_product.id}`;
        }
